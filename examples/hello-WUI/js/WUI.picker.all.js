...
})(window.WUI || window, window, document, undefined);
//end
/**
 * 弹出选择列表插件
 * 此组件依赖 listpcker ，请在页面中先引入 WUI.picker.css + WUI.picker.js
 * varstion 1.0.1
 */
...
(function($, document) {
	...
	var panelBuffer = '<div class="WUI-poppicker">\
		<div class="WUI-poppicker-header">\
			<button class="WUI-btn WUI-poppicker-btn-cancel">取消</button>\
			<button class="WUI-btn WUI-btn-blue WUI-poppicker-btn-ok">确定</button>\
			<div class="WUI-poppicker-clear"></div>\
		</div>\
		<div class="WUI-poppicker-body">\
		</div>\
	</div>';

	var pickerBuffer = '<div class="WUI-picker">\
		<div class="WUI-picker-inner">\
			<div class="WUI-pciker-rule WUI-pciker-rule-ft"></div>\
			<ul class="WUI-pciker-list">\
			</ul>\
			<div class="WUI-pciker-rule WUI-pciker-rule-bg"></div>\
		</div>\
	</div>';
	...
	var PopPicker = $.PopPicker = $.Class.extend({
		...
		init: function(options) {
			...
			self.ok = self.panel.querySelector('.WUI-poppicker-btn-ok');
			self.cancel = self.panel.querySelector('.WUI-poppicker-btn-cancel');
			self.body = self.panel.querySelector('.WUI-poppicker-body');
...
(function($, document) {
	...
	var domBuffer = '<div class="WUI-dtpicker" data-type="datetime">\
		<div class="WUI-dtpicker-header">\
			<button data-id="btn-cancel" class="WUI-btn">取消</button>\
			<button data-id="btn-ok" class="WUI-btn WUI-btn-blue">确定</button>\
		</div>\
		<div class="WUI-dtpicker-title"><h5 data-id="title-y">年</h5><h5 data-id="title-m">月</h5><h5 data-id="title-d">日</h5><h5 data-id="title-h">时</h5><h5 data-id="title-i">分</h5></div>\
		<div class="WUI-dtpicker-body">\
			<div data-id="picker-y" class="WUI-picker">\
				<div class="WUI-picker-inner">\
					<div class="WUI-pciker-rule WUI-pciker-rule-ft"></div>\
					<ul class="WUI-pciker-list">\
					</ul>\
			...
			<div data-id="picker-m" class="WUI-picker">\
				<div class="WUI-picker-inner">\
					<div class="WUI-pciker-rule WUI-pciker-rule-ft"></div>\
					<ul class="WUI-pciker-list">\
					</ul>\
			...
			<div data-id="picker-d" class="WUI-picker">\
				<div class="WUI-picker-inner">\
					<div class="WUI-pciker-rule WUI-pciker-rule-ft"></div>\
					<ul class="WUI-pciker-list">\
					</ul>\
			...
			<div data-id="picker-h" class="WUI-picker">\
				<div class="WUI-picker-inner">\
					<div class="WUI-pciker-rule WUI-pciker-rule-ft"></div>\
					<ul class="WUI-pciker-list">\
					</ul>\
			...
			<div data-id="picker-i" class="WUI-picker">\
				<div class="WUI-picker-inner">\
					<div class="WUI-pciker-rule WUI-pciker-rule-ft"></div>\
					<ul class="WUI-pciker-list">\
					</ul>\
