			...
			if ($.isFunction(self.options.down.callback)) {
				self.pullDownTips = (function() {
					...
					if (!element) {
						...
						element.innerHTML = '<div class="WUI-pull-top-wrapper"><span class="WUI-pull-loading WUI-icon WUI-icon-pulldown"></span></div>';
			...
			if ($.isFunction(self.options.up.callback)) {
				self.pullUpTips = (function() {
					...
					if (!element) {
						...
						element.innerHTML = '<div class="WUI-pull-bottom-wrapper"><span class="WUI-pull-loading">' + self.options.up.contentdown + '</span></div>';
